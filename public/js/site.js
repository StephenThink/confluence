...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start(); // const ham = document.getElementById('ham');
...
if (el) {
  ...
  var flkty = new (flickity_fade__WEBPACK_IMPORTED_MODULE_1___default())(el, (_Flickity = {
    // options
    pageDots: true,
